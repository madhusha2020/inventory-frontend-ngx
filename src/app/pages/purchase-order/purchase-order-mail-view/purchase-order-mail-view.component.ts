...
@Component({
  selector: 'ngx-purchase-order-mail-view',
  templateUrl: './purchase-order-mail-view.component.html',
  styleUrls: ['./purchase-order-mail-view.component.scss']
})
export class PurchaseOrderMailViewComponent implements OnInit {
