...
export const APIS = [AuthenticationControllerService, CustomerControllerService, EmployeeControllerService, ImageUploadControllerService, ItemControllerService, OrderControllerService, ProductOutboundControllerService, RoleControllerService, UserControllerService];
