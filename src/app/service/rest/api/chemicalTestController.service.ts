...
@Injectable()
export class ChemicalTestControllerService {
    ...
    /**
     * View a list of available chemical tests
     * 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getAllChemicalTestsUsingGET(observe?: 'body', reportProgress?: boolean): Observable<ChemicalTestList>;
    public getAllChemicalTestsUsingGET(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ChemicalTestList>>;
    public getAllChemicalTestsUsingGET(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ChemicalTestList>>;
    public getAllChemicalTestsUsingGET(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
